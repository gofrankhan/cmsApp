...
$(document).ready(function() {
    ...
    $('#movement_datatable_simple thead th.sortable').on('click', function(e) {
        ...
        $('#movement_datatable_simple thead th').removeClass('asc desc');
        $(this).addClass(order);
        sortTable(column, order);
    });

    function sortTable(column, order) {
        const rows = $('#movement_datatable_simple tbody tr').get();
        ...
        $.each(rows, function(index, row) {
            $('#movement_datatable_simple tbody').append(row);
        });
    }
...
<script>
    ...
    function FilterServiceType(){
        ...
        $.ajax({
            ...
            type: "GET",
            data: { service_type : serviceType, shop_name : shopName, file_id: file_id, customer_name: customer_name, all_data : false },
