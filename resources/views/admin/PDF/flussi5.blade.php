...
p, table {
  font-size: 16px;
    ...
    <title>Impegno certificato idoneita Alloggiativa</title>
...
<body>
    <div class="abcdx"> 
        ...
        <h5 align="center"><b>A FORNIRE IL CERTIFICATO DI IDONEITA' ALLOGGIATIVA</b></h5>
        ...
        <table>
            <tr>
                <td text-align="justify">a consegnare l'idoneità alloggiativa in originale, su richiesta da parte dello
                        sportello unico per l'immigrazione, in fase di istruttoria per
                </td>
            </tr>
        </table>
