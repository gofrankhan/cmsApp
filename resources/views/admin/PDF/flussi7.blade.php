...
p, table {
  font-size: 16px;
    ...
    <title>Impegno Documentoo Asseverazione</title>
...
<body>
    <div class="abcdx"> 
        ...
        <table>
            <tr>
                <td text-align="justify">a consegnare in originale, il documento di Asseverazione prodotta da un
                        professionista abilitato ed iscritto all'albo, su richiesta da parte dello sportello
                        unico per l'immigrazione, in fase di istruttoria dell'istanza di Flussi Immigratori.
                </td>
            </tr>
        </table>
