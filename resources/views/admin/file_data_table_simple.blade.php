    ...
    <script>
        $(document).ready(function() {
            $('#show_filter_list').change(function() {
                ...
                $('#file_datatable tbody tr').each(function() {
                    if (filterType === "shop")
                        var rowValue = $(this).find('td:nth-child(4)')
                            .text(); //index 4 is for shop)
                    if (filterType === "service")
                        var rowValue = $(this).find('td:nth-child(5)')
                            .text(); //index 5 is for service)
                    if (filterType === "status")
                        var rowValue = $(this).find('td:nth-child(7)')
                            .text(); //index 7 is for shop)
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(index, item) {
                                $("#service").append("<option value='" + item.service +
                                    "'>" + item.service + "</option>");
                            });
                        }
                    });
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="card-title">File Informations @if ($user_type == 'admin')
                        <sub><a href="{{ route('file.data.simple', 'all') }}" id="view_all"> View All </a></sub>
                    @endif
                </h4>
            ...
            <div class='row'>
                <div class='col' align="left">
                    <a href="" class="btn btn-secondary waves-effect waves-light" id='btn_clear_filters'>Clear
                        Filters</a>
                </div>
                    ...
                    <tr>
                        <th class="sortable filterable" data-column="1">
                            ...
                            <div class="filter-container" style="display: none;">
                                <input type="text" id="search_file_id" class="form-control filter-input"
                                    placeholder="File ID">
                            </div>
                        </th>
                        <th class="sortable filterable" data-column="1">
                        ...
                        <th class="sortable filterable" data-column="1">
                            ...
                            <i class="fas fa-sort sort-icon"></i>
                            <div class="filter-container" style="display: none;">
                                <input type="text" id="search_customer_name" class="form-control filter-input"
                        ...
                        <div id="modal_daterange" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div>
                                                <input class="form-control" type="date" value="<?= date('Y-m-d') ?>"
                                                    id="start_date_modal" name="start_date_modal">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div>
                                                <input class="form-control" type="date" value="<?= date('Y-m-d') ?>"
                                                    id="end_date_modal" name="end_date_modal">
                                            </div>
                                        </div>
                                        <div>
                                            <button type="submit"
                                                class="btn btn-outline-primary waves-effect waves-light"
                                                id="apply_daterange">Apply</button>
                                        </div>
                                    </div>
                                </div><!-- /.modal-content -->
                            </div><!-- /.modal-dialog -->
                        ...
                        <th class="sortable filterable" data-column="1">
                            ...
                            <i class="fas fa-calendar calendar-icon" data-bs-toggle="modal"
                ...
                <tr>
                    ...
                    <td style="width:2%">
                        ...
                        @elseif($r->status == 'Submitted')
                            <div class="font-size-13"><i
                                    class="ri-checkbox-blank-circle-fill font-size-10 text-dark align-middle me-2"></i>
                            </div>
                            ...
                            <div style="width:150px" class="row">
                                <form action="{{ route('customer.delete', $r->id) }}" method="post">
                                    <a class="btn btn-outline-secondary btn-sm edit"
                                        href="{{ route('file.show', $r->file_id) }}" target="_blank" title="Show">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a class="btn btn-outline-secondary btn-sm edit"
                                        href="{{ route('file.edit', $r->file_id) }}" target="_blank" title="Edit">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <a type="submit" class="btn btn-danger btn-sm edit"
                                        href="{{ route('file.delete', $r->file_id) }}" title="Delete">
                        ...
                        @else
                            ...
                            @else
                                <div style="width:150px" class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <a class="btn btn-outline-secondary btn-sm edit"
                                            href="{{ route('file.edit', $r->file_id) }}" title="Edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="" id="form2">
                            ...
                            <div class="row" id="div_description">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" id="description" class="form-control" placeholder="Descriptioin" name="description">
                                                </textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            @if ($user_type != 'user')
                                <button id="submit-admin" type="submit"
                ...
                success: function(data) {
                    ...
                    $.each(data[0], function(index, item) {
                        ...
                        if (item.is_subscribed == '1')
                            var cell21 = $("<td style='width:2%'>").html(
                                "<div><i class='ri-vip-crown-fill' style='color: #cf2847;'></i></div>"
                            );
                        else
                        ...
                        if (item.status == "Completed")
                            var cell6 = $("<td style='width:2%'>").html(
                        ...
                        var htmlContentAdmin =
                            ...
                            '<div class="col-md-4">' +
                            '<a class="btn btn-outline-secondary btn-sm edit" href="/file/show/' + item
                            .file_id + '" target="_blank" title="Show">' +
                            "<i class='fas fa-eye'></i>" +
                            "</a>" +
                            "</div>" +
                            '<div class="col-md-4">' +
                            '<a class="btn btn-outline-secondary btn-sm" href="/file/edit/' + item
                            .file_id + '" target="_blank" title="Show">' +
                            "<i class='fas fa-pencil-alt'></i>" +
                            "</a>" +
                            "</div>" +
                        ...
                        if (user_type == "admin")
                            ...
                            if (item.status == "Completed" || item.status == "Cancelled" || user_type ==
                                "lawyer") {
                        ...
                        row.append(cell1, cell2, cell21, cell3, cell4, cell5, cell51, cell6, cell7,
                            cell8);
