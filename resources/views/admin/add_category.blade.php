        ...
        <div class="row">
            <div class="col">
                <div id="field_wrapper1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <input  type="submit" id="add_button1" class="btn btn-rounded btn-sm btn-outline-primary waves-effect waves-light" value="+">
                        </div>
                    </div>
                </div>
                <div class="col-sm-2">
            ...
            <div class="col">
                <div id="field_wrapper2">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-8">
                            <input class="form-control" name="service_name" placeholder="Service Name" type="text" id="service_name" >
                        </div>
                        <div class="col-sm-2">
                            <input  type="submit" id="add_button2" class="btn btn-sm btn-outline-primary btn-rounded waves-effect waves-light" value="+">
                        </div>
                    </div>
                </div>
                <div class="col-sm-2">
