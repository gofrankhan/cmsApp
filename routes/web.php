...
Route::middleware('auth')->group(function(){
    ...
    Route::get('/flussi4/{id}', [PDFController::class, 'flussi4'])->name('flussi4');
    Route::get('/flussi5/{id}', [PDFController::class, 'flussi5'])->name('flussi5');
    Route::get('/flussi6/{id}', [PDFController::class, 'flussi6'])->name('flussi6');
    Route::get('/flussi7/{id}', [PDFController::class, 'flussi7'])->name('flussi7');
    Route::get('/flussi8/{id}', [PDFController::class, 'flussi8'])->name('flussi8');
    Route::get('/flussi9/{id}', [PDFController::class, 'flussi9'])->name('flussi9');
    Route::get('/flussi10/{id}', [PDFController::class, 'flussi10'])->name('flussi10');
