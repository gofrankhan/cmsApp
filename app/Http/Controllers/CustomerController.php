...
class CustomerController extends Controller
{
    ...
    public function CustomerExport()
    {
        ...
        // Add headers
        fputcsv($handle, ['Tax ID', 'First Name', 'Last Name', 'Date of Birth', 'Address', 'Phone No', 'City', 'Region', 'Post Code', '']);

        // Add rows
        foreach ($customers as $customer) {
            fputcsv($handle, [$customer->taxid, $customer->firstname, $customer->lastname, $customer->dateofbirth, $customer->addressline1, $customer->mobile, $customer->city, $customer->region, $customer->postcode]);
        }
